...
type DonWebPartnerPageProps = {
  partner: Partner;
};

function DonWebLinkButton({
  link,
  primary = false,
}: {
  link: PartnerLink;
...
function DonWebFaqCard({ item }: { item: PartnerFaq }) {
  return (
...
export default function DonWebPartnerPage({
  partner,
}: DonWebPartnerPageProps) {
  ...
  const capabilityIcons = [Globe, Cloud, Boxes, Gauge, Headphones];
    ...
    <>
      <section className="relative overflow-hidden pb-16 pt-28">
        <div className="absolute inset-0">
          ...
          <div className="floating-orb-3 bottom-[-7rem] left-1/3"></div>
        </div>
        ...
        <div className="mx-auto max-w-6xl space-y-8 px-4 sm:px-6 lg:px-8">
          <section className="grid gap-8 xl:grid-cols-[1.05fr,0.95fr]">
            <div className="glass-card rounded-3xl border border-slate-200/80 p-8 md:p-10 dark:border-white/[0.08]">
              ...
              <div className="mt-8">
                <DonWebLinkButton link={detail.allianceLink} />
              </div>
            </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <h2 className="mt-2 text-2xl font-bold text-slate-950 dark:text-white">
                    Capacidad operativa para infraestructura y crecimiento
                  </h2>
                </div>
              </div>
          ...
          <section className="glass-card rounded-3xl border border-slate-200/80 p-8 md:p-10 dark:border-white/[0.08]">
            ...
            <h2 className="mt-4 text-3xl font-bold text-slate-950 dark:text-white md:text-4xl">
              Implementacion tecnica con criterio de negocio
            </h2>
          ...
          <section>
            ...
            <h2 className="mt-4 text-3xl font-bold text-slate-950 dark:text-white md:text-4xl">
              Escenarios donde sumamos valor con DonWeb
            </h2>
          ...
          <section className="grid gap-8 xl:grid-cols-[1.1fr,0.9fr]">
            <div className="glass-card rounded-3xl border border-slate-200/80 p-8 md:p-10 dark:border-white/[0.08]">
              ...
              <div className="mt-8 grid gap-4 md:grid-cols-2">
                {detail.faq.map((item) => (
                  <DonWebFaqCard key={item.question} item={item} />
                ))}
              </div>
            </div>
